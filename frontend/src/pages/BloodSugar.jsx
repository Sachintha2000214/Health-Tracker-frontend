...
export default function BloodSugar() {
  ...
  const handleManualSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await axios.post("https://health-tracker-backend-s5ei-umr8y997a.vercel.app//api/patient/bloodsugar", {
        userId,
        docId,
        type: testType,
  ...
  const handleFileUpload = async () => {
    ...
    setUploading(true);
    try {
      await axios.post("https://health-tracker-backend-s5ei-umr8y997a.vercel.app//api/patient/upload/bloodsugar", formData, {
